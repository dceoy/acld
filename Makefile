...
export VARIANT CONTAINERFILE IMAGE REMOTE_IMAGE NAME HOST_IP PORT CPUS MEMORY VNC_GEOMETRY VNC_DEPTH VNC_PASSWORD HOME_VOLUME WORKSPACE_DIR MIN_MACOS_MAJOR
